...
public class Dev {
    ...
    private String nome;
    private Set<Conteudo> conteudoInscritos = new LinkedHashSet<>(); // Usamos porque precisamos de elementos unicos
    private Set<Conteudo> conteudosConcluidos = new LinkedHashSet<>(); // como só pode inscrever em um curso não usamos Array
